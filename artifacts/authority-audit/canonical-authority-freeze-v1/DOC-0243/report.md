# DOC-0243 — user-approved canonical V3.3 authority freeze
...
- Canonical occurrences: **129**
- Semantic nodes: **109**
- PRIMARY: **109**; REPEAT: **0**; CONTINUATION: **20**
- Parent edges: **109**
- ROOT children: **13**
- Max depth: **3**
...
The approved identity artifact collapses 20 occurrence(s) through the explicitly recorded identity relation(s); no membership was changed during freeze.
...
Input artifact hashes are recorded in uthority-freeze-manifest.json.
