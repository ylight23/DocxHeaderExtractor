...
if (options.Inputs.Count == 0 && options.Command is not ("sample" or "info" or "bench" or "eval" or "accuracy99" or "r18" or "harness-lift" or "local-qwen-preflight" or "local-qwen-large" or "a99-v6-whole-alias-replay" or "a99-v6-source-slice-audit" or "a99-v6-source-slice-challenger" or "a99-v6-source-fidelity-audit"))
{
