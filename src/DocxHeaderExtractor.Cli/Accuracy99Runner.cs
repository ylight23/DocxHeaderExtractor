...
internal static class Accuracy99Runner
{
    ...
    public static async Task<int> RunAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        ...
        {
            Console.WriteLine("accuracy99 operations: packet, inventory, evaluate, baseline, observability, reference-campaign, early-dev-campaign, review-ui, review-ui-v3, gold-validate, gold-import-dev, gold-validate-v2, gold-import-dev-v2, gold-validate-v3, gold-import-dev-v3, gold-validate-strict-v3, gold-import-strict-dev-v3, gold-preflight-strict-dev, gold-authority-policy-v2, gold-occurrence-bindings, reasoning-retention, reasoning-retention-smoke, openrouter-qwen35-smoke, openrouter-qwen9b-true-ceiling, openrouter-qwen37-flash-control, openrouter-qwen37-request-ladder, openrouter-qwen37-flash-reasoning-ceiling, openrouter-qwen37-flash-visual-ceiling, openrouter-qwen37-flash-visual-audit, doc0205-semantic-taxonomy-audit, doc0205-semantic-contract-reconciliation, semantic-text-exact-binding, semantic-text-generalization, a99-v6-production-accuracy, a99-v6-visual-e2e, semantic-text-generalization-offline, semantic-text-generalization-recover-0258-r2, semantic-text-source-boundaries, model-capability-isolation, model-capability-isolation-resume, semantic-contrast-contract, semantic-contrast-contract-resume, semantic-text-omission-review, semantic-text-residual-loop-i1, semantic-text-residual-loop-i1-resume, semantic-text-omission-review-offline, semantic-text-omission-review-recover-0001-r1, semantic-text-duplicate-disambiguation, semantic-text-duplicate-disambiguation-resume, semantic-text-duplicate-disambiguation-offline, semantic-text-repeat-stability-audit, semantic-text-stable-error-repair, semantic-text-stable-error-repair-recover-0252-r4, semantic-text-stable-error-repair-clean-completion, semantic-text-stable-error-repair-resume-0252-r5-r6, semantic-text-stable-error-loop, semantic-text-residual-gap-loop, model-omission-stability, residual-error-attribution, canonical-heading-contract-v2, heading-target-ontology-v4, structure-preserving-ir, structure-preserving-ir-vlm, doc0205-contract-audit, flash-heading-contract-realignment, openrouter-qwen9b-executable-ceiling, openrouter-qwen9b-per-segment-recovery, openrouter-qwen9b-provider-diagnosis, openrouter-qwen9b-provider-resume, openrouter-qwen9b-multipass-doc0205, doc-0205-canary, mode-stratification, doc-0027-support-canary");
            return 0;
        }
        ...
        return operation switch
        {
            ...
            "a99-v6-provider-determinism" => await RunA99V6ProviderDeterminismAsync(options, cancellationToken),
            ...
            "semantic-contrast-contract" => await RunSemanticContrastContractAsync(options, cancellationToken),
            "semantic-contrast-contract-resume" => await RunSemanticContrastContractResumeAsync(options, cancellationToken),
            ...
            "semantic-text-residual-loop-i1" => await RunSemanticTextResidualLoopI1Async(options, cancellationToken),
            "semantic-text-residual-loop-i1-resume" => await RunSemanticTextResidualLoopI1ResumeAsync(options, cancellationToken),
            ...
            "semantic-text-duplicate-disambiguation" => await RunSemanticTextDuplicateDisambiguationAsync(options, cancellationToken),
            "semantic-text-duplicate-disambiguation-resume" => await RunSemanticTextDuplicateDisambiguationResumeAsync(options, cancellationToken),
            "semantic-text-duplicate-disambiguation-offline" => await RunSemanticTextDuplicateDisambiguationOfflineAsync(options, cancellationToken),
            ...
            "semantic-text-stable-error-repair-resume-0252-r5-r6" => await RunSemanticTextStableErrorRepairResumeAsync(options, cancellationToken),
            "semantic-text-stable-error-loop" => await RunSemanticTextStableErrorLoopAsync(options, cancellationToken),
            "semantic-text-residual-gap-loop" => await RunSemanticTextResidualGapLoopAsync(options, cancellationToken),
            "model-omission-stability" => await RunModelOmissionStabilityAsync(options, cancellationToken),
            "residual-error-attribution" => await RunResidualErrorAttributionAsync(options, cancellationToken),
    ...
    private static Task<int> RunA99V6RequestEquivalenceAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
    ...
    private static Task<int> RunA99V6ProviderDeterminismAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return A99V6ProviderDeterminismProbeRunner.RunAsync(repoRoot, cancellationToken);
    }
    ...
    private static Task<int> RunA99V6ProductionAccuracyAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunV6ProductionAccuracyAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunA99V6VisualE2EAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return CanonicalSemanticVisualE2ERunner.RunAsync(repoRoot, cancellationToken);
    }
    ...
    private static Task<int> RunModelCapabilityIsolationAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunModelCapabilityIsolationAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunModelCapabilityIsolationResumeAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.ResumeModelCapabilityIsolationAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticContrastContractAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunSemanticContrastContractAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticContrastContractResumeAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.ResumeSemanticContrastContractAsync(repoRoot, cancellationToken);
    }
    ...
    private static Task<int> RunSemanticTextResidualLoopI1Async(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunSemanticTextResidualLoopI1Async(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticTextResidualLoopI1ResumeAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunSemanticTextResidualLoopI1ResumeAsync(repoRoot, cancellationToken);
    }
    ...
    private static Task<int> RunSemanticTextDuplicateDisambiguationAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunDuplicateDisambiguationAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticTextDuplicateDisambiguationResumeAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.ResumeDuplicateDisambiguationAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticTextDuplicateDisambiguationOfflineAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunDuplicateDisambiguationOfflineAsync(repoRoot, cancellationToken);
    }
    ...
    private static Task<int> RunModelOmissionStabilityAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunModelOmissionStabilityAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunResidualErrorAttributionAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.RunResidualErrorAttributionAsync(repoRoot, cancellationToken);
    }
    ...
    private static Task<int> RunSemanticTextStableErrorRepairResumeAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextGeneralizationRunner.ResumeStableErrorRepairDoc0252R5R6Async(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticTextStableErrorLoopAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextStableErrorLoopRunner.RunAsync(repoRoot, cancellationToken);
    }

    private static Task<int> RunSemanticTextResidualGapLoopAsync(CommandLineOptions options, CancellationToken cancellationToken)
    {
        var repoRoot = FindRepositoryRoot(options.Accuracy99Root ?? Directory.GetCurrentDirectory());
        return SemanticTextResidualGapLoopRunner.RunAsync(repoRoot, cancellationToken);
    }
