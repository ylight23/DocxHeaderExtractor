...
public static class PdfTaggedHeadingAnalyzer
{
        ...
        where TParagraph : IPolicyParagraph
    {
        try
        {
            ...
            return new PdfTaggedHeadingAnalyzerReport(
        ...
        {
            return new PdfTaggedHeadingAnalyzerReport(pdfPath, 0, 0, 0, 0,
...
public sealed record PdfTaggedHeadingAnalyzerReport(
    string Pdf,
    int Pages,
