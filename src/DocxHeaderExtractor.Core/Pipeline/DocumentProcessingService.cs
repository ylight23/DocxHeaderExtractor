...
/// <summary>
/// Canonical application surface for structure and schema-routed fact extraction. Hosts compose
/// this service; they do not choose validators, authorities, or source representations.
/// </summary>
public sealed class DocumentProcessingService : IDocumentProcessingService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var facts = await new DocumentFactExtractionRuntime(
                _factProducer, _schemaPacks)
            .ExtractFactsAsync(
                extraction,
    ...
    /// <summary>Compatibility host adapter that keeps repair quarantine inside the authority run.</summary>
