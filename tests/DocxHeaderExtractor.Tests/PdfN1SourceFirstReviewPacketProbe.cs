...
public sealed class PdfN1SourceFirstReviewPacketProbe
{
    ...
    public void WritePackets()
    {
        ...
        var manifestSha256 = N0BenchmarkManifestIdentity.ComputeCanonicalN0ManifestSha256(manifestPath);
    ...
    public void CommittedPacketsBindToN0AndContainNoPipelineFields()
    {
        ...
        var manifestSha256 = N0BenchmarkManifestIdentity.ComputeCanonicalN0ManifestSha256(Path.Combine(root, "keys", "benchmark-n0", "manifest.json"));
