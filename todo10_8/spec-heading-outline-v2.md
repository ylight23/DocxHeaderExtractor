...
navigation body 61/64 nhưng exact title hỏng. OpenStax 056 từng là dạng **occurrence nhập nhằng**,
nhưng trên HEAD sau các sửa ngày 2026-08-14 đã đạt navigation 46/46 và cấp 46/46; exact-title vẫn
thấp vì nhiều title còn dính body/inline text. Giả thuyết `TitleThe body...` là lỗi whitespace tầng
XML chưa được xác nhận — phép đo raw `<w:t>` bị nhiễu bởi `w:br`. Vì vậy mọi luật Typed mới phải
nói rõ nó xử lý subtype nào; không được dùng marker-last/occurrence-last đại trà vì RFC
registry/reference đã bác.
...
| `typed-numbering` | B, RFC 9111, OpenStax 056 | có cho RFC 9111; exact title 1,7% sau filter footer, điều hướng 61/64. Có thêm key OpenStax 056: exact P/R/F1 9,5%/87,0%/17,2%, returned 419, navigation 46/46, level 46/46, truth candidate 82,6%. 31/31 file Typed corpus là text-layout nặng |
