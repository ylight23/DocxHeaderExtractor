...
The final execution revision is `2cdac63b619898b3839cc22d512353e82fa67304`. Release build,
focused gates, and diff-check passed. The full suite measured 992 tests: 991 passed, 1 failed, and
0 skipped. The sole failure is the frozen N15 fingerprint mismatch; it is not a new R18 failure and
its expected artifact was not changed. Provider calls for the deterministic gates were zero.
